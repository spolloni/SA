...
\input{figures/bblu_test_spfe_top_lonely}
\midrule
\input{figures/bblu_test_spfe_type_top_lonely}
\bottomrule
\end{tabular}
\end{table}
...
\input{figures/census_pers_test_spk_top_lonely}
\midrule
\input{figures/census_pers_test_spk_type_top_lonely}
\bottomrule
...
\input{figures/census_test_spk_top_lonely}
\midrule
\input{figures/census_test_spk_type_top_lonely}
\bottomrule
...
\toprule
 ...
 \textbf{All Projects} \\
 \input{figures/price_fe_30_top.tex}
 \midrule
\input{figures/price_type_fe_30_top.tex}
\bottomrule
