...
&\multicolumn{3}{c}{Overlap with} &\multicolumn{3}{c}{0 to 1 km from} &\multicolumn{3}{c}{1 to 4 km from}  \\
\cmidrule(lr){2-4}\cmidrule(lr){5-7}\cmidrule(lr){8-10} 
 & Uncon & Con & Both & Uncon & Con & Both  & Uncon & Con & Both  \\ 
\\[-.5em]
Buildings \\ \midrule
\\[-.5em]
\input{figures/pre_table_bblur}
\\[-.5em]
...
\toprule
\input{figures/main_new_spill_full_int}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%% COMMENTED OUT ALL OF THE WELFARE SECTION %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/main_new_test_matching3_top}
\bottomrule
\\
\input{figures/inf_census_test_matching3_top}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/main_new_test_pweight_top}
\bottomrule
\\
\input{figures/inf_census_test_pweight_top}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
