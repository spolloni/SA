...
% unconstructed projects may be exposed to different trends in development at the neighborhood. 
...
% \quad y_{ipt} \, =& \, \alpha  \textsc{\small Proj}_{p}\times\textsc{\small Post}_{t}\times\textsc{\small Const}_{p} \, + \, \alpha \textsc{\small Proj}_{p}\times\textsc{\small Post}_{t} \, + \, \alpha \textsc{\small Proj}_{p}\times\textsc{\small Const}_{p} \, + \\
% & \, \alpha  \textsc{\small Spill}_{p}\times\textsc{\small Post}_{t}\times\textsc{\small Const}_{p} \, + \, \alpha \textsc{\small Spill}_{p}\times\textsc{\small Post}_{t} \, + \, \alpha \textsc{\small Spill}_{p}\times\textsc{\small Const}_{p} \, + \\
% & \, \alpha  \textsc{\small Post}_{t}\times\textsc{\small Const}_{p} \, + \, \alpha \textsc{\small Post}_{t} \, + \, \alpha  \textsc{\small Proj}_{p} \, + \, \alpha  \textsc{\small Spill}_{p} \, + \, \alpha \textsc{\small Const}_{p} \, + \, \varepsilon_{ipt} \quad 
% \end{align*}
\begin{align*}\label{eq:main}
