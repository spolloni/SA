...
In developing countries, 30\% of urban populations live in crowded slums, which suffer from low infrastructure access, unsanitary conditions, and high crime rates \citep{mdg}.  The main policy response has been building large-scale housing projects.  To motivate these projects, policymakers stress how moving from slums to public housing may improve household wellbeing.  Existing research confirms this intuition, linking public housing to improvements in child health, women's employment, and wellbeing for recipient households \citep{cattaneo2009housing,franklin2016enabled,galiani2017shelter}.  

Policymakers have also pushed a step further; they hypothesize that the benefits of public housing may spillover to neighboring areas.  In South Africa, housing projects are constructed with goals of ``leveraging growth in the economy, [...] combating crime, promoting social cohesion, [...] and utilizing housing as an instrument for the development of sustainable human settlements, in support of spatial restructuring'' \citep{bng}.  

% have prevented previous studies from 
% and improve neighborhood quality as well as economic growth
%Despite the importance of spillover effects for policy design, empirical research has not yet examined these effects in a developing country setting.

In contrast, standard economic theory predicts more ambiguous  spillover effects.  Housing projects increase local supply, which can depress local housing quantities and prices.  Projects may also provide negative amenities by relocating low-income households to these neighborhoods.  At the same time, improved infrastructure and housing quality within projects may stimulate positive housing investments nearby.\footnote{Studying affordable housing projects in the US, \cite{diamond2016wants} confirm the importance of these opposing amenity effects according to baseline neighborhood quality.}  Yet, any positive effects may be dampened if they attract greater slum growth nearby.\footnote{\cite{Brueckner2018backyarding} document the common practice of ``backyarding'' where households construct informal dwellings on the same land plot as project houses.}  	Without precise spatial data or large numbers of housing projects, previous research has neglected to test these hypotheses empirically.  

To fill this gap, this paper analyzes the spillover effects of 117 large public housing projects in South Africa.  
...
We combine administrative records for \input{figures/total_cluster_rdp}completed housing projects in the province of Gauteng, with data on property transactions, formal and informal housing densities, and dwelling characteristics to measure the local impact of these projects.   
...
Our empirical estimates rely on a difference-in-differences design leveraging both the timing of housing project construction as well as the precise geography of treated areas. Like prior studies in the US, the substantial uncertainty in project timing due to difficulties coordinating many stakeholders and sources of funding limits the extent to which local housing markets are able to anticipate the projects \citep{diamond2016wants, serihistory}.  To address the potential endogenous placement of housing projects, we analyze \input{figures/total_cluster_placebo}planned but unconstructed projects as counterfactuals and detect no impacts of these uncompleted projects on local housing markets.
