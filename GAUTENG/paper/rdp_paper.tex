...
The promoted goals of such programs are twofold. First, policymakers stress how subsidized housing improves household wellbeing along a variety of dimensions. This is well supported by existing studies on direct recipient impacts, which link housing programs to improvements in child health, women's employment, and quality of life \citep{cattaneo2009housing,franklin2016enabled,galiani2017shelter}. A second set of policy goals pertains to broader urban development impacts, driven by spillovers to neighboring areas. For instance, subsidized housing in South Africa is proposed for ``leveraging growth in the economy, [...] combating crime, promoting social cohesion, [...] and utilizing housing as an instrument for the development of sustainable human settlements, in support of spatial restructuring'' \citep{bng}. 

Spillover effects may account for a significant share of the total welfare impacts of housing projects.  In the US, \cite{diamond2016wants} calculate that affordable housing in low-income areas generates substantial benefits on surrounding areas, often exceeding the total costs of these programs.  In developing settings, lax building codes and zoning laws make for more ambiguous predictions on the types of spillovers produced by housing projects.

Welfare effects may be even greater developing settings where preexisting slums impose negative externalities on neighboring areas.

Projects may increase local housing supply, which can depress prices and new construction.

%In contrast to optimism from policymakers, economic theory has more ambiguous predictions for the types of spillover effects produced by housing projects.  

Housing projects may also provide negative amenity value by bringing large numbers of low-income households to a neighborhood.  

At the same time, improved infrastructure and greater housing quality within projects may stimulate housing investments nearby.\footnote{Studying affordable housing projects in the US, \cite{diamond2016wants} confirm the importance of these opposing amenity effects according to baseline neighborhood quality.}  

Any positive effects may be dampened if projects also attract greater slum growth nearby.\footnote{\cite{Brueckner2018backyarding} document the common practice of ``backyarding'' where households construct informal dwellings on the same land plot as project houses.}  

Both the policy importance and theoretical ambiguity of these spillover effects motivate empirical analysis in a developing context.  However, researchers have so far lacked the spatial data and quantity of housing projects needed to precisely identify impacts on local neighborhoods.
