...
%%% STATEMENT HERE!  
	...
	We estimate the effects of large public housing projects on local formal and informal housing markets in South Africa.  Using aerial measures of housing density, deeds records, and census data, we compare constructed projects to planned, but unconstructed projects in a differences-in-differences design.  We find that housing projects increase housing quality and quantity within their footprints.  Yet, just outside of project footprints, we detect growth of low-quality, informal housing especially near urban centers.
...
Rapid urbanization has increased the demand for housing in cities, especially in the developing world.\footnote{Since 2000, the share of populations living in urban areas has grown from 40 to 50\% in low and middle income countries [World Bank Data].} Yet,  30\% of urban populations in developing countries live in slums characterized by overcrowding, low infrastructure access, unsanitary conditions, and high crime rates. These living conditions are thought to pose long-lasting obstacles to upward mobility and local economic development \citep{marx2013slums}.  Policymakers often point to slum growth as evidence that formal markets are unable to meet rising demand for housing.\footnote{In South Africa, policy makers point to housing discrimination such as financial ``red lining,'' which has led to a ``backlog'' of ``1.8 dwellings which can be classified as inadequate housing'' \citep{bng}.}  To boost the supply of formal housing, many cities build large public housing projects --- in some cases, replacing entire slum neighborhoods with new houses.  

Housing projects aim to reduce slum growth by incentivizing households to leave their slum dwellings and claim new public houses.  At the same time, these projects may attract growth of low-quality, informal housing within and around their footprints.  Housing projects require services such as piped water, sewers, electricity, roads, and community centers, all of which can be shared with neighboring households.  By clearing and rezoning land around project houses, these policies may lower the cost of constructing nearby informal structures.  Family members of project beneficiaries may also move locally to maintain social ties (\cite{franklin2016enabled}).  In South Africa, \cite{Brueckner2018backyarding} document a common practice of ``backyarding,'' where households rent informal dwellings erected on the same land plots as their project houses.  While public housing may be intended to substitute for slum living, housing projects may also stimulate growth of low-quality, informal housing.

Improving local infrastructure, lowering construction costs, and boosting neighborhood quality are ways in which the welfare benefits of housing projects may flow beyond their boundaries.  However, when people crowd around projects to enjoy these benefits, they may not fully internalize how their locations and investments in home quality affect their neighbors' welfare.  Population density may congest access to public goods while low-quality building materials may accelerate the spread of disease (\cite{cattaneo2009housing}).  Empirically, these negative externalities may generate lower prices for nearby formal housing despite increases in housing density and improvements in infrastructure access.



% ; however, housing projects may also generate local welfare costs through greater slum development.  These benefits may attract new 

% By measuring how many people are willing to move nearby nearby projects, changes in local housing, population, and house prices 

%  the welfare benefits of housing projects can extend beyond their boundaries.  These benefits may be reflected in 

% When households crowd around projects to benefit from local public goods or lower construction costs, they may not fully internalize how their relocation decisions affect their neighbors' welfare.  Population density may congest access to public goods while low-quality building materials may accelerate the spread of disease (\cite{cattaneo2009housing}).  Empirically, these negative externalities may generate lower prices for nearby formal housing.  

% However, these welfare benefits may be mitigated by growth in local 

%  provide welfare benefits by 

% By improving local public goods, lowering construction costs, and boosting neighborhood characteristics, housing projects improve welfare 

% By measuring how many people are willing build new houses nearby projects, local housing growth captures how these projects affect social welfare in their surroundings.  

% As people taking advantage of local public goods, low construction costs, or improved neighborhood characteristics offered by these projects.
% Housing growth may reflect 


% However, if people do not consider how their new houses may impact their neighbors' welfare, then local housing growth may 

% However, when households crowd around projects, they may not fully internalize how their relocation decisions affect their neighbors' welfare.  

% Dense neighborhoods may congest access to public goods while low-quality building materials may accelerate the spread of disease (\cite{cattaneo2009housing}). 



% Local housing growth has ambiguous implications for the social welfare consequences of housing projects.  

% Housing growth may result from households moving away from less desirable areas far from projects to newly desirable areas around housing projects.  In this context, housing growth may provide a way of measuring how the welfare benefits of housing projects extend outside of their boundaries.

%  measure the welfare benefits 


% households moving away from less desirable locations far from projects, reflecting an improvement in social welfare.  In this way, welfare gains of housing projects extend beyond 





% Housing growth may provide evidence of welfare gains as households move from less desirable locations far from projects to new houses near project boundaries.


% providing desirable   either through local public goods, low construction costs, or improved neighborhood characteristics.

% When households move nearby these projects, 

% to take advantage of local public goods or lower construction costs created by their, they are 


%  whether extending the reach of local public goods or benefiting from lower construction costs.  

% On one hand, improvements in 

% From a welfare perspective, housing growth provides evidence that public housing projects improve the desirability of housing projects 

% In standard developed country settings, increased housing investments are often interpreted as as a welfare gain 


% people move to an area and construct new homes 

% usually 



% Can be interpreted, traditionally??



% HOW IS LOCAL HOUSING GROWTH A POSITIVE?!

% Vote with feet

% Households moving nearby housing projects, 


% amplify the positive welfare effects of housing projects beyond their boundaries.  

% Housing growth nearby 


% While local housing growth provides evidence of positive welfare effects of the housing policy , 



% -- depending on the type of housing or the density of people, they may also generate negative externalities


% Welfare effects of slum programs:

% - lower construction costs 

% %by extending access to basic infrastructure beyond their footprints.

% %improve local infrastructure as well as clear land around project houses.
% % which 
% %%% need to clearly differentiate from Brueckner!?

% Local slum growth may mitigate positive welfare effects of public housing projects.  When households crowd around projects to benefit from local public goods or lower construction costs, they may not fully internalize how their relocation decisions affect their neighbors' welfare.  Population density may congest access to public goods while low-quality building materials may accelerate the spread of disease (\cite{cattaneo2009housing}).  Empirically, these negative externalities may generate lower prices for nearby formal housing.  

% These TWO effects will be reflected in local housing prices!!!

% dense low-quality housing threatens to congest access to these public goods while also generating negative externalities like crime and poor sanitation.  

% The welfare effects of housing projects may extend well beyond their footprints.  Nearby housing growth would suggest that projects provide attractive local amenities .  

% Growth of nearby housing provides evidence of positive local amenity effects as households choose to move nearby housing projects, often taking advantage of new, local public goods.  

% simply subtracting construction costs from gains to direct beneficiaries
% local housing growth ensures that public goods from housing projects are able to benefit a greater number of households.  This mechanism predicts increases in access to services for informal as well as formal houses.  

% around project footprints has ambiguous implications for the welfare effects of public housing policy.  Without slum growth, welfare effects can be summarized by weighing gains to housing beneficiaries against land and production costs.

% \footnote{Costs may also include dead-weight losses from distortions in the local housing supply.}  Slum growth indicates additional welfare effects 

% beneficiaries, and any deadweight losses from increasing the supply of housing (cite).

% compare the costs of public housing construction to the 
% has ambiguous implications for social welfare.  
% On one hand, local slum growth
...
\toprule
  &Constructed &Unconstructed \\
\midrule
\input{figures/descriptives_table}
...
\midrule
\input{figures/descriptives_table_het}
\bottomrule
...
\midrule
\input{figures/census_at_baseline_AGG} 
\bottomrule
...
\midrule
\input{figures/census_at_baseline_AGG_het} 
\bottomrule
...
\small
\centering
\caption{Census Household-level Estimates Het}\label{table:censusestimateshet}
\vspace{-2mm}
\begin{tabular}{lDDDDDDDD}
\toprule
 & \small (1) & \small (2)  & \small (3) & \small (4) & \small (5)  & \small (6)  & \small (7) & (8)\\
 & \small Flush Toilet & \small Water Indoors  & \small Electricity Cooking & \small Electricity Heating & \small Electricity Lighting  & \small Number of Rooms  & \small Household Size & Population Density\\ \midrule 
\input{figures/census_hh_DDregs_AGG_het_less}
\bottomrule
\multicolumn{9}{l}{\footnotesize All regressions include project Fixed-Effects. Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 }
\end{tabular}
\end{table}
...
\toprule
 & \small (1) & \small (2) & \small (3) & \small (4) \\ \midrule 
\input{figures/price_regDDD_het.tex}
\bottomrule
\multicolumn{5}{l}{\footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 }
\end{tabular}
\end{table} 
...
\begin{table}[h!] 
\caption{Effect of Housing Projects on Socio-demographics Het}
