...
%  & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
%  \\[-.5em]
...
% \small
% \centering
% \caption{Housing Density per $\text{km}^{2}$ Estimates ZEROES APPENDIX}\label{table:bbluDDDfull}
% \vspace{-2mm}
% \resizebox{1\linewidth}{!}{
% \begin{threeparttable}
% \begin{tabular}{lCCCCC}
...
%  & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
%  \\[-.5em]
% \input{figures/bblu_overlap_zeros}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
% \item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
% \small
% \centering
% \caption{Housing Density per $\text{km}^{2}$ Estimates SPILL ZEROES APPENDIX}\label{table:bbluDDDfull}
% \vspace{-2mm}
% \resizebox{1\linewidth}{!}{
% \begin{threeparttable}
% \begin{tabular}{lCCCCC}
...
%  & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
%  \\[-.5em]
% \input{figures/bblu_overlap_spill_zeros}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
% \item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
\small
\centering
\caption{NEW TOP Housing Density per $\text{km}^{2}$ Estimates LAG APPENDIX}\label{table:bbluDDDfull}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
\toprule
& \small (1) & \small (2) & \small (3) & \small (4) & \small (5) \\
 & \small $\Delta$ Total Housing & \small $\Delta$ Formal Housing & \small $\Delta$ Informal Housing & \small $\Delta$ Informal Non-Bkyd. Housing  & \small $\Delta$ Informal Backyard Housing\\ \midrule
 \\[-.5em]
\input{figures/bblu_spill_test_new_top}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
\small
\centering
\caption{NEW TOP CENSUS Estimates LAG APPENDIX}\label{table:bbluDDDfull}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
\toprule
& \small (1) & \small (2) & \small (3) & \small (4) & \small (5) \\
 & \small $\Delta$ Pop Density & \small $\Delta$ Water Inside & \small $\Delta$ Flush Toilet & \small $\Delta$ Electricity  & \small $\Delta$ Rooms\\ \midrule
 \\[-.5em]
\input{figures/census_spill_test_new_top}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
\small
\centering
\caption{NEW Housing Density per $\text{km}^{2}$ Estimates LAG APPENDIX}\label{table:bbluDDDfull}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
...
& \small (1) & \small (2) & \small (3) & \small (4) & \small (5) \\
 & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
 \\[-.5em]
\input{figures/bblu_spill_test_new}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
\small
\centering
\caption{NEW CENSUS Estimates LAG APPENDIX}\label{table:bbluDDDfull}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
\toprule
& \small (1) & \small (2) & \small (3) & \small (4) & \small (5) \\
 & \small Pop Density & \small Water Inside & \small Flush Toilet & \small Electricity  & \small Rooms\\ \midrule
 \\[-.5em]
\input{figures/census_spill_test_new}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
\small
\centering
\caption{DENSITY  Estimates SEPARATED }\label{table:bbluDDDfull}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
...
\small
\centering
\caption{DENSITY  Estimates COMPARISON }\label{table:bbluDDDfull}
\vspace{-2mm}
...
& \small (1) & \small (2) & \small (3) & \small (4) \\
 & \small $\Delta$ Total Housing & \small $\Delta$  Total Housing & \small $\Delta$  Total Housing & \small $\Delta$  Total Housing  \\[1em]
\textsc{Distance Metric} & \multicolumn{2}{c}{\% Buffer Overlap with Project} & \multicolumn{2}{c}{Distance to Project Boundary} \\\cmidrule(lr){2-3}\cmidrule(lr){4-5}
 \\[-.5em]
...
% \small
% \centering
% \caption{Housing Density per $\text{km}^{2}$ Estimates LAG APPENDIX}\label{table:bbluDDDfull}
% \vspace{-2mm}
% \resizebox{1\linewidth}{!}{
% \begin{threeparttable}
% \begin{tabular}{lCCCCC}
...
%  & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
%  \\[-.5em]
% \input{figures/bblu_overlap_lag}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
% \item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
% \small
% \centering
% \caption{Housing Density per $\text{km}^{2}$ Estimates SPILL LAG APPENDIX}\label{table:bbluDDDfull}
% \vspace{-2mm}
% \resizebox{1\linewidth}{!}{
% \begin{threeparttable}
% \begin{tabular}{lCCCCC}
...
%  & \small Total Housing & \small Formal Housing & \small Informal Housing & \small Informal Non-Bkyd. Housing  & \small Informal Backyard Housing\\ \midrule
%  \\[-.5em]
% \input{figures/bblu_spill_overlap_lag}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
% \item \footnotesize Standard errors clustered at the project level in parenthesis. \textsuperscript{c} p$<$0.10,\textsuperscript{b} p$<$0.05,\textsuperscript{a} p$<$0.01 \,\,
...
% \begin{align*}
% U &= \delta_{hlt} - \frac{\lambda}{2} k_{hjt} - \theta R_{hjt}   + \epsilon_{hjt}  
% \end{align*}

% \begin{align*}
% \label{eq:rent}
% R_{hjt}^{*}(k_{hjt}) &= \frac{ \delta_{hlt} - \frac{\lambda}{2} k_{hjt} + \epsilon_{hjt} - \overline{U}}{\theta}
% \end{align*}
