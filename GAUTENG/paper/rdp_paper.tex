...
\midrule
Implementation & \input{figures/implementation_r} &  \input{figures/implementation_p} \\
Planning   &         \input{figures/planning_r} & \input{figures/planning_p} \\
Proposed   &          \input{figures/proposed_r}  &    \input{figures/proposed_p}  \\
No Description &     \input{figures/none_r}  &    \input{figures/none_p}  \\ 
Total             &  \input{figures/total_r}  &    \input{figures/total_p}  \\
\bottomrule
\end{tabular}
\end{table}
