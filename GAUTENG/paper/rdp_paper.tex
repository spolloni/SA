...
Rapid urbanization has increased the demand for housing in cities, especially in the developing world.\footnote{Since 2000, the share of populations living in urban areas has grown from 40 to 50\% in low and middle income countries [World Bank Data].} Yet,  30\% of urban populations in developing countries live in slums characterized by overcrowding, low infrastructure access, unsanitary conditions, and high crime rates \citep{mdg}.\footnote{These living conditions are thought to pose long-lasting obstacles to upward mobility and local economic development \citep{marx2013slums}.}  Policymakers often point to slum growth as evidence that formal markets are unable to meet rising demand for housing.\footnote{In South Africa, policy makers point to housing discrimination such as financial ``red lining,'' which has led to a ``backlog'' of ``1.8 dwellings which can be classified as inadequate housing'' \citep{bng}.}  Many cities work to reduce slum growth by building large public housing projects --- in some cases, replacing entire slum neighborhoods with new houses.  While many housing beneficiaries leave their slum dwellings behind in order to claim new public houses, their family members and other households often build new low-quality, informal houses within and around project footprints.  These neighboring households can share public goods such as piped water, sewerage, electricity, roads, and community centers provided by large housing projects.  In South Africa, \cite{Brueckner2018backyarding} document a common practice of ``backyarding,'' where households rent informal dwellings erected on the same land plots as their government-sponsored houses.  Despite providing a substitute to slum dwellings for  beneficiaries, public housing projects may also provide an effective mix of public goods to attract nearby slum growth.

In this paper, we measure the impacts of large-scale public housing projects in South Africa on the growth of nearby formal and informal housing markets.  South Africa's National Housing Program is unique among developing countries in its massive scale, having allocated over 3 million houses across hundreds of projects since 1994.  The large volume of projects allows us to identify both local and neighborhood impacts, building on previous research that has focused primarily on direct impacts on recipients \citep{cattaneo2009housing,franklin2016enabled,galiani2017shelter}.  
...
Also, satellite measures of housing development over time and administrative deeds records combine to measure the evolution of local    in the development, building on previous cross-sectional studies \cite{harari2018slum}.
...
However, introducing large-scale .  
