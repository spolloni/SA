...
Spillover effects may account for a significant share of the total welfare impacts of housing projects.  In the US, \cite{diamond2016wants} calculate that affordable housing in low-income areas generates substantial benefits on surrounding areas, often exceeding the total costs of these programs. In developing countries, lax building codes and weak zoning laws make for more ambiguous predictions on the types of spillovers produced by housing projects.

%These effects are heterogeneous, however, and depend on the relative urban amenity provided by the government-sponsored constructions.
