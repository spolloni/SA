...
\begin{table}[h!]
\centering
\caption{Average Outcomes per Plot Inside and Nearby Projects before Project Construction}\label{table:projectdescriptives}
\vspace{0mm}
...
Positive effects on local prices are consistent with public housing projects providing positive local amenities.  Yet, the statistical insignificance of these results means that we cannot exclude the possibility of zero or even negative effects of projects on local prices.  One reason for these statistically insignificant results may be that deeds records are relatively rare occurring on only 7.6\% of plots.  This finding demonstrates the difficulty of estimating spillover effects using official deeds records in contexts where housing transactions are unlikely to be officially recorded.
...
We consider three possible mechanisms to explain both positive direct and spillover effects of housing projects.  First, projects may affect in \textit{neighborhood quality} by changing both the quality of houses (\cite{rossi2010housing}) and the types of people living in these houses (\cite{diamond2016wants}).  Changes in the types neighborhood may change investment decisions in nearby areas even if these areas do not directly benefit from the projects.  Second, housing projects may be accompanied by 
...
\small
\centering
\caption{Public Service Buildings}\label{table:inf_census}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
...
\small
\centering
\caption{Household Demographics}\label{table:demo}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCCC}
...
\small
\centering
\caption{Agglomeration Outcomes}\label{table:inf_census}
\vspace{-2mm}
\resizebox{1\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}{lCCCC}
...
Direct Effect (Footprint) &  \input{figures/welfare/med_dir_for} & \input{figures/welfare/med_dir_inf} & \input{figures/welfare/med_dir_tot} \\
...
Spillover Effect  &  \input{figures/welfare/med_spi_for} & \input{figures/welfare/med_spi_inf} & \input{figures/welfare/med_spi_tot} \\
