...
\bottomrule
\multicolumn{6}{l}{\footnotesize Standard errors clustered at the project level in parenthesis. * p$<$0.10,** p$<$0.05,*** p$<$0.01 }
\end{tabular}
\end{table}
% \begin{table}
% \caption{Census Household-level Estimates}\label{table:censusestimates}
...
\begin{figure*}[t!]
        \centering
        \caption{Housing Density Estimation}\label{fig:DDDbblu}
        \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \caption[]{Total Houses}  
            \vspace{-2mm}
        ...
        \begin{subfigure}[b]{0.49\textwidth}  
            \centering
            \caption[]{Backyard Informal Houses}  
            \vspace{-2mm}
        ...
        \begin{subfigure}[b]{.49\textwidth}  
            \centering
            \caption[]{Non-Backyard Informal Houses} 
            \vspace{-2mm}
...
We also normalize the coefficient for the furthest distance bin outside of the boundary, $\alpha^{d=1200}$ to zero so that the other coefficients, $\alpha^{d \neq 1200}$ can be interpreted relative to this furthest category.  Comparing coefficients in this way allows for a triple-differences interpretation by adding the near/far difference to the constructed/unconstructed and pre/post differences.  This triple-differences interpretation requires the additional assumption that the differential changes between constructed and unconstructed projects at all distances from project boundaries would have evolved in the same ways as corresponding changes furthest from project boundaries in the absence of project construction.  This assumption is likely to hold when (1) any spillover effects fully dissipate within 1,200 meters from project boundaries and (2) differential shocks to local housing markets for constructed versus unconstructed projects are uncorrelated with distance inside this radius.
