...
Focusing on formal housing density in Figure \ref{fig:prefor}, we find low densities of formal housing within both unconstructed and constructed project areas. This finding is consistent with governments locating projects on relatively vacant land.  Formal housing density jumps discontinuously at the project boundary and quickly stabilizes at a higher level across positive distances.  Figure \ref{fig:preinf} presents the inverse pattern for informal housing, finding high levels of informal housing within project areas that discontinuously decline just outside of the boundaries.  Taken together, areas just outside and further away from boundaries have similar levels of housing development at baseline.

Figures \ref{fig:forchange} and \ref{fig:infchange} extend this exercise by plotting average changes in building densities between 2001 and 2011.
