...
Rapid urbanization has increased the demand for housing in cities, especially in the developing world.\footnote{Since 2000, the share of populations living in urban areas has grown from 40 to 50\% in low and middle income countries [World Bank Data].} Yet,  30\% of urban populations in developing countries live in slums characterized by overcrowding, low infrastructure access, unsanitary conditions, and high crime rates \citep{mdg}.\footnote{These living conditions are thought to pose long-lasting obstacles to upward mobility and local economic development \citep{marx2013slums}.}  Policymakers often point to slum growth as evidence that formal markets are unable to meet rising demand for housing.\footnote{In South Africa, policy makers point to housing discrimination such as financial ``red lining,'' which has led to a ``backlog'' of ``1.8 dwellings which can be classified as inadequate housing'' \citep{bng}.}  To boost the supply of formal housing, many cities build large public housing projects --- in some cases, replacing entire slum neighborhoods with new houses.  

Housing projects aim to reduce slum growth by incentivizing households to leave their slum dwellings and claim new public houses.  At the same time, these projects improve local infrastructure, which may attract growth in low-quality, informal housing within and around project footprints.  Housing projects require services such as piped water, sewers, electricity, roads, and community centers, all of which can be shared informally with neighboring households.  In South Africa, \cite{Brueckner2018backyarding} document a common practice of ``backyarding,'' where households --- especially family members of project beneficiaries ---  rent informal dwellings erected on the same land plots as their government-sponsored houses.  While public housing may be intended to substitute for slum living, housing projects may also stimulate local slum growth by extending access to basic infrastructure beyond their footprints.
...
\begin{table}[h!]
\centering
\caption{Housing Projects Areas Description Heterogeneity}\label{table:projectdescriptives_het}
\vspace{0mm}
\begin{tabular}{l*{1}{cccc}}
\toprule
  & \multicolumn{2}{c}{City}  & \multicolumn{2}{c}{Suburb}   \\
...
\multicolumn{5}{l}{\scriptsize $^\ddagger$Measured as the average minimum distance with respect to Johannesburg and Pretoria CBDs. }
\end{tabular}
\end{table} 
...
\begin{table}[h!]
	\centering
	\caption{Dwelling Characteristics at Baseline from 2001 Census Het}\label{table:projectdescriptivescensushet}
\vspace{-2mm}
\begin{tabular}{l*{1}{ccccc}}
\toprule
& Const City & Unconst City & Const Suburb & Unconst Suburb &  All  \\
\midrule
...
\begin{figure*}[h!]
        \centering
        \caption[ Housing Densities in Constructed and Unconstructed Projects Areas Het]
        {\small Housing Densities in Constructed and Unconstructed projects Het} 
        %\vspace{2mm}
        \begin{subfigure}[b]{0.495\textwidth}
            \centering
            \includegraphics[width=\textwidth,trim={0.3cm .3cm 0.1cm 0cm}, clip=true]{figures/bblu_for_pre_means_het_near.pdf}
            \caption[Network2]%
            {{\small formal density near CBD}}    
        ...
        \begin{subfigure}[b]{0.495\textwidth}  
            ...
            \caption[]%
            {{\small informal density near CBD}}    
        ...
        \begin{subfigure}[b]{0.495\textwidth}
            ...
            \caption[Network2]%
            {{\small formal density far from CBD}}    
        ...
        \begin{subfigure}[b]{0.495\textwidth}  
            ...
            \caption[]%
            {{\small informal density far from CBD}}    
