...
\begin{split}
\quad y_{ipnt} \, =& \sum_{q=1}^{4} \, Q_{s}^{q} \, \Bigg[ \,  \,   \textsc{\small Proj}_{ip} \,\, \Big( \alpha_1^q \, \textsc{\small Post}_{t}\times\textsc{\small Const}_{i} \, + \, \alpha_2^q \, \textsc{\small Post}_{t} \, + \, \alpha_3^q \, \textsc{\small Const}_{p}\, +\, \alpha_4^q \Big) \, + \\[.2em]
& \, \textsc{\small Spill}_{ip} \, \Big( \beta_1^q \, \textsc{\small Post}_{t}\times\textsc{\small Const}_{p} \, + \, \beta_2^q \, \textsc{\small Post}_{t} \, + \, \beta_3^q \, \textsc{\small Const}_{p} \, +\, \beta_4^q \Big) \, + \\[.2em]
& \, \gamma_1^q \,  \textsc{\small Post}_{t}\times\textsc{\small Const}_{p} \, + \, \gamma_2^q \,\textsc{\small Post}_{t} \, + \, \gamma_3^q \,  \textsc{\small Proj}_{p} \, \Bigg] \, + \, \theta \, X_{ipnt} \, + \, \lambda_s \, + \, \varepsilon_{ipnt} \quad 
\end{split}
\end{align}
\noindent where $q$ indexes neighborhood income quartiles, and $Q_s^q$ takes a value of one if average household income for neighborhood $s$ falls within quartile $q$.  Average income is measured according to household incomes reported in the 2001 Census of Population and Housing.  
...
\multicolumn{5}{l}{\footnotesize Coefficients are interactions with constructed, $\textsc{Const}_{i}$  and post, $\textsc{Post}_{t}$ indicators.}\\[-.3em]
...
To identify the spillover effects of public housing on local housing markets,


%  we adopt the specification from Section~\ref{section:bbluestimates}, instead using transaction price as an outcome:
