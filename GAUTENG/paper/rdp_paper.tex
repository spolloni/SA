...
We locate housing projects using administrative maps compiled by the Gauteng City Regional Authority.  These records include \input{figures/total_gcro}planned housing projects as well as notes on their completion status.\footnote{Since this data comes in the form of overlapping shapefiles, we use the intersection of the shapes excluding tiny shapes below 0.50 square kilometers.}  
