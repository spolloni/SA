...
\begin{abstract}
	...
	Does subsidized housing improve neighborhood quality in developing countries? We estimate economic spillovers from a large public housing program in South Africa using geocoded deeds records, remote sensed housing density, and census data.  To identify project impacts, we compare constructed and unconstructed projects at fine geographic levels using a difference-in-differences design.  Within project footprints, housing quality improves and subsidized formal structures successfully crowd-out slums. Yet just outside of project footprints, we detect no significant changes in housing quantity, quality, or price. 
...
%The main policy response has been building large-scale housing projects. 
%For example, the South African government has provided over 3 million dwellings since 1994, housing around 20\% of their total population.\footnote{\citep{dhsreports} counts dwellings while the percentage is from authors' calculations using the 2016 General Household Survey.}  

To motivate these projects, policymakers stress how moving from slums to public housing improves household wellbeing, which is well supported by existing research.\footnote{Existing research links public housing to improvements in child health, women's employment, and wellbeing for recipient households \citep{cattaneo2009housing,franklin2016enabled,galiani2017shelter}.}  Policymakers then push a step further and argue that the benefits of public housing spillover to neighboring areas.  In South Africa, housing projects are proposed for ``leveraging growth in the economy, [...] combating crime, promoting social cohesion, [...] and utilizing housing as an instrument for the development of sustainable human settlements, in support of spatial restructuring'' \citep{bng}.  Spillover effects may account for a significant share of the total welfare effects of housing projects.  \cite{diamond2016wants} calculate that affordable housing in the US generates large welfare impacts on surrounding areas, often exceeding the total costs of these programs.  Welfare effects may be even greater developing settings where preexisting slums impose negative externalities on neighboring areas (\cite{10.1257/jep.27.4.187}).

In contrast to optimism from policymakers, economic theory has more ambiguous predictions for the types of spillover effects produced by housing projects.  Projects may increase local housing supply, which can depress prices and new construction.  Housing projects may also provide negative amenity value by bringing large numbers of low-income households to a neighborhood.  At the same time, improved infrastructure and greater housing quality within projects may stimulate housing investments nearby.\footnote{Studying affordable housing projects in the US, \cite{diamond2016wants} confirm the importance of these opposing amenity effects according to baseline neighborhood quality.}  Any positive effects may be dampened if projects also attract greater slum growth nearby.\footnote{\cite{Brueckner2018backyarding} document the common practice of ``backyarding'' where households construct informal dwellings on the same land plot as project houses.}  Both the policy importance and theoretical ambiguity of these spillover effects motivate empirical analysis in a developing context.  However, researchers have so far lacked the spatial data and quantity of housing projects needed to precisely identify impacts on local neighborhoods.


%Developing countries feature additional housing externalities such as poor sanitation, 

% - any welfare accounting needs to take into account spillover effects
% - diamond finds they are important in developed countries
% - there are reason to believe they may be especially important in developing countries because externalities are often more salient/stronger


%Studying public housing projects in the US, \cite{diamond2016wants} find that their welfare effects on surrounding areas dwarf the costs of public housing in low-income areas.  
%However, researchers have lacked similar spatial data or quantity of housing projects needed to precisely measure spillovers in a developing setting.  


 

% Lacking precise spatial data or large numbers of housing projects

This paper analyzes the direct and spillover effects of a large public housing program in South Africa.  We combine administrative records for \input{figures/total_cluster_rdp}constructed and \input{figures/total_cluster_placebo}planned but unconstructed projects with spatial data on property transactions, formal and informal housing densities, and dwelling characteristics.  To measure spillovers, we implement a simple difference-in-differences design at varying distances from project boundaries.  At each distance, we compare changes in outcomes for constructed projects to changes for planned but unconstructed projects.  This non-parametric approach allows us to precisely capture how spillover effects dissipate across space.  Planned but unconstructed project areas provide useful counterfactuals since governments often select lower-quality, less populated land for building housing projects.  These unconstructed areas closely resemble constructed project areas at baseline across a range of measures including preexisting housing density.  


% Baseline similarities suggest that outcomes for both areas would have evolved similarly in the absence of project construction, which is our main identifying assumption.  
% before and after project construction

Looking within project areas, we estimate large improvements in access to services and home quality, but little effects on housing density.  Small effects on total density mask a large compositional change from informal to formal housing.  We also find greater densities of informal backyard houses, but not enough to offset the steep declines in other types of informal housing.  Using census data, we find little change in household demographics, employment, or population.  Taken together, these results suggest that housing projects may provide positive local amenities through better house quality and improved infrastructure.  Moreover, there is little evidence of countervailing supply effects, population sorting, or slum growth within project areas.

Despite better housing quality within projects, we estimate zero spillover effects across our full range of outcomes.  Housing projects do not appear to stimulate additional construction of formal or informal dwellings at all distances outside project boundaries.  Similarly, demographics and housing quality in neighboring areas remains the same after project construction.  Leveraging the exact timing of construction, we do not detect a discrete change in formal housing prices just following construction although we provide some evidence that housing markets anticipate projects.

These findings provide suggestive evidence that neighborhood externalities may play a minimal role in housing markets in developing countries.  Another interpretation is that informal backyard houses produce strongly negative externalities which negate any positive benefits of formal project houses.  
From a policy perspective, these results suggest that spillover effects may merit less emphasis than the direct effects on recipients in designing future housing policy.  
...
% but no effects on surrounding areas.  We also find no statistically significant effects of public housing on prices in the formal market.  



%[ MOVE THIS LOWER PLEASE ]  Like prior studies in the US, the substantial uncertainty in project timing due to difficulties coordinating many stakeholders and sources of funding limits the extent to which local housing markets are able to anticipate the projects \citep{diamond2016wants, serihistory}.  

%To address the potential endogenous placement of housing projects, we use \input{figures/total_cluster_placebo}planned but unconstructed projects as our counterfactual project areas.



%To interpret these findings, we provide a simple conceptual framework balancing the amenity effects of improved housing quality against the price and quantity effects of a housing supply shock.  This framework helps shed light on the absence of spillover effects detected in our analysis.


% At the same time, relocating low-income households to project areas may constitute a negative amenity to surrounding housing markets (another source).  





% show that spillovers depend on existing neighborhood quality, finding positive effects for low-income areas 


% Our empirical strategy combines...


% - housing is an amenity -- affect local values

% - housing is also a supply shock -- affect local values

% - backyarding, which can have their own 





% impacts of public housing projects on the price, quality, and quantity of housing both within and just outside project footprints.  

%the existing literature has focused on estimating direct recipient impacts \citep{cattaneo2009housing,franklin2016enabled,galiani2017shelter}


% , the broader consequences of subsidized housing for urban development remain poorly understood.


%According to the Department of Human Settlements, this program is designed not only to serve as ``a key strategy for poverty alleviation'' for direct beneficiaries, but also to generate community-wide benefits, ``leveraging growth in the economy, [...] combating crime, promoting social cohesion, [...] and utilizing housing as an instrument for the development of sustainable human settlements, in support of spatial restructuring'' \citep{bng}. 



% We estimate economic spillovers from a large-scale housing program in South Africa, focusing on the quality, density, and price of nearby housing. Providing over 3 million houses, this program is one of the largest in the developing world and continues to respond to large backlogs in demand \citep{dhsreports}.  


%%%% replacement versus greenfield pitch


%Combined with low infrastructure access and insecure property rights, slum conditions are thought to pose long-lasting obstacles to upward mobility and local economic development \citep{10.1257/jep.27.4.187}. 
...
%These programs aim to provide not only direct health and economic benefits to recipients, but also greater incentives for neighbors to invest in their homes and communities.  Local investments may reduce negative externalities and steer residents away from poverty traps. 

%At the same time, subsidized housing may attract slums by improving access to bulk services like water and sanitation as well as providing under-utilized developable land within project areas. 
%These indirect housing opportunities are especially salient in South Africa where {\it backyarding} is a common and widely documented form of land use.\footnote{See recent work by \cite{Brueckner2018backyarding}.} 

%In this way, public housing programs may ultimately exacerbate the same negative externalities they were designed to remediate. 
...
%In Figure \ref{figure:densitytime}, we plot monthly transaction densities around the modal transaction month for every constructed project, separating project transactions (upper panel) from non-project transactions (lower panel).
...
%Like prior studies in the US, the substantial uncertainty in project timing due to difficulties coordinating many stakeholders and sources of funding limits the extent to which local housing markets are able to anticipate the projects \citep{diamond2016wants, serihistory}.
...
%The findings in this section suggest both that (1) governments select low-cost land to implement projects and (2) the decision to finish project construction does not appear to be strongly correlated with pre-existing levels of development in the project areas.  
%At least in terms of building composition, density, and value, unconstructed projects seem to provide a better comparison group for constructed projects than simply examining nearby areas. 
%Average densities within project areas appear display substantial variation with distance especially for unconstructed projects, 
%We also observe some variation in average densities within project areas  especially for unconstructed 
...
%To ensure that the this measure excludes any project houses, we limit the analysis to transactions for seller names who transact less than 30 houses over the full period.  While this metric 
...
\begin{figure*}[t!]
        ...
        \begin{subfigure}[b]{0.495\textwidth}
            \centering
            \includegraphics[width=\textwidth,trim={0.3cm .3cm 0.1cm 0cm}, clip=true]{figures/price_pre_means}
            \caption[Network2]%
        ...
        \begin{subfigure}[b]{0.495\textwidth}   
            \centering 
            \includegraphics[width=\textwidth,trim={0.3cm .3cm 0.1cm 0cm}, clip=true]{figures/prices_rawchanges}
            \caption[]%
...
%These types of selection are important to consider when interpreting our results and to help motivate the difference-in-differences empirical strategy
%lag behind constructed project areas across all demographic measures.  At the same time, constructed project areas are almost indistinguishable from nearby, non-project areas despite having fewer structures and greater population densities.
%Taken together, these findings are consistent with governments (1) selecting low-cost land to implement projects and (2) facing high costs of finishing projects in dense slums.  These types of selection are important to consider when interpreting our results and to help motivate the difference-in-differences empirical strategy.
...
% One potential concern is that whether a project is ultimately constructed depends on changes in the local housing market as well as local economic and political conditions, which may separately drive changes in census outcomes.  For example, residents of quickly growing neighborhoods may be more likely to petition local governments to stall or stop housing projects.  Similarly, it may be easier to finish housing projects in areas where informal housing grows slowly.  Both of these factors may lead this approach to overestimate the impacts of public housing.  At the same time, the extent to which constructed projects are misclassified as unconstructed would lead this approach to underestimate the true effects of this program.
...
%We also normalize the coefficient for the furthest distance bin outside of the boundary, $\alpha^{d=1200}$ to zero so that the other coefficients, $\alpha^{d \neq 1200}$ can be interpreted relative to this furthest category.  


%Comparing coefficients in this way allows for a triple-differences interpretation by adding the near/far difference to the constructed/unconstructed and pre/post differences.  This triple-differences interpretation requires the additional assumption that the differential changes between constructed and unconstructed projects at all distances from project boundaries would have evolved in the same ways as corresponding changes furthest from project boundaries in the absence of project construction.  This assumption is likely to hold when (1) any spillover effects fully dissipate within 1,200 meters from project boundaries, (2) differential shocks to local housing markets for constructed versus unconstructed projects are uncorrelated with distance within this radius, and (3) recipient households are not drawn from households living at 1,200 meters from the project area.



%\begin{equation}
%\label{equation:prices}
%P_{ipt} \, = \sum\limits_{d} I^d_{ip}\Big( \alpha^d D_tC_p \, + \, \beta^dD_t \, + \theta^{d} \Big) \, + \, \varepsilon_{ipt}
%\end{equation}
%\begin{equation*}
...
%The outcome, $P_{itp}$, is measured in terms of the log-purchase price of property $i$ sold at time $t$ in the vicinity of project $p$.  To capture changes in prices over time within project areas, $D_{tp}$ is equal to one if date $t$ is after the month of project implementation and zero otherwise.  



%$T_{ip}$ takes a value of one if property $i$ is within 700m of the project boundary (zero otherwise).  


%The coefficient of interest, $\alpha$ captures the differential change in prices between near and far properties before and after project construction.   


%Interpreting the coefficient, $\alpha$, as the causal effect of housing projects on nearby home prices requires assuming that housing prices for constructed project would have changed in the same way as housing prices for unconstructed projects at each distance from the project boundary.  
...
\small
\centering
\caption{Census Composition Estimates }\label{table:censusperson}
\vspace{-2mm}
...
\caption{Buffer Design for Census Small Areas}\label{figure:bufferdesigncensus}
\centering
\includegraphics[scale=1.2,trim={.75cm .4cm .75cm 1cm,clip=true}]{figures/projectcounts.pdf}
\end{figure}
