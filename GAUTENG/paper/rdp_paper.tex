...
% \footnote{Qualitative interviews with national and local government housing officials that we conducted between 2015 and 2017 suggest that housing subsidy programs are viewed as being in contradiction to an outcome of densifying backyard shacks.} }
...
% @article{rondinelli1990housing,
%   title={Housing the Urban Poor in Developing Countries: The Magnitude of Housing Deficiencies and the Failure of Conventional Strategies are World-wide Problems},
...
\\[-.5em]
\input{figures/pre_table_censusr}
\\[-.5em]
House Prices \\ \midrule
\\[-.5em]
\input{figures/pre_table_pricesr}
\\[-.5em]
Geographic Features\\ \midrule
\\[-.5em]
\input{figures/pre_table_geor}
% \\[-.3em]
...
% Buildings \\ \midrule
% \\[-.5em]
% \input{figures/pre_table_bblu1}
% \\[-.5em]
% Census Measures \\ \midrule
% \\[-.5em]
% \input{figures/pre_table_census1}
% \\[-.5em]
% House Prices \\ \midrule
% \\[-.5em]
% \input{figures/pre_table_prices1}
% \\[-.5em]
% Geographic Features\\ \midrule
% \\[-.5em]
% \input{figures/pre_table_geor}
...
% % & Uncon & Con & Uncon & Con \\
% \midrule
% \input{figures/areatableplot_rdp}	
% \\[-.5em]
% Plot rings (km) \\
% that overlap with \\
% constructed projects \\
% \input{figures/areatable_rdp}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
...
% & Uncon & Con & Uncon & Con \\
% \midrule
% \input{figures/areatableplot1}	
% \\[-.5em]
% Plot rings (km) \\
% with project overlap \\
% \input{figures/areatable}
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
...
\begin{tabular}{lCC}
\toprule
\input{figures/main_formal_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\\
\\\midrule
\input{figures/demo_formal_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCC}
\toprule
\input{figures/inf_bblu_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCC}
\toprule
\input{figures/main_informal_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/inf_census_informal_top_proj}
\\
\\\midrule
\input{figures/demo_informal_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/inf_census_top_spill}
\\
\\\midrule
\input{figures/demo_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize
...
\rv{We then estimate potential spillover effects on business growth nearby projects.  Appendix Table~\ref{table:agglom_spill} finds positive coefficients on both total businesses and informal businesses although these effects are statistically insignificant to the point that we cannot reject substantial negative effects.  These estimates suggest little scope for substantial spillovers in economic development nearby projects.}
...
\toprule
\input{figures/cbd_close_top_proj}
% \bottomrule
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/cbd_close_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCCC}
\toprule
\input{figures/cbd_far_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/cbd_far_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
% From a policy perspective, these results indicate that policymakers in developing contexts may consider pairing housing projects with broader investments in basic infrastructure in anticipation of informal backyard housing growth \citep{visagie2020getting}.
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/main_full_spill_1}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/main_full_spill_2}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCCC}
\toprule
\input{figures/matching_top_proj}
\bottomrule
\\
\input{figures/matching_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCCC}
\toprule
\input{figures/p_score_top_proj}
\bottomrule
\\
\input{figures/p_score_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\toprule
\input{figures/post_2001_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/post_2001_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
% \textbf{Direct Effects} \\
\toprule
\input{figures/far_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/far_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
% \textbf{Direct Effects} \\
\toprule
\input{figures/dropplacebo_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/dropplacebo_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
% \textbf{Direct Effects} \\
\toprule
\input{figures/robust_time_var_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/robust_time_var_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
% \textbf{Direct Effects} \\
\toprule
\input{figures/census_ea_top_proj}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/census_ea_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize This table shows the direct and spillover effects of constructed housing projects on population and housing outcomes where the pre-period (Post=0) is 1996 and the post-period is 2001 (Post=1). \regtextfirst The Bonferonni correction is calculated separately for columns (1) to (6) and (7) to (12).
...
% \textbf{Direct Effects} \\
\toprule
\input{figures/robust_buildings_top_proj1}
\\
\textbf{Spillover Effects} \\\midrule
\input{figures/robust_buildings_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/robust_dist_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize  This table shows the spillover effects for 0.1 km rings from 0 to 0.5 km from plots \rw{in order to test for localized spillover effects within 0.5 km of projects}.  The full set of 0.5 km rings from 0.5 to 4 km from plots are also included as controls although the coefficients are not included here.  \regtextfirst
\end{tablenotes}
\end{threeparttable}
}
\end{table}
...
\begin{tabular}{lCC}
\toprule
\input{figures/agglom_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \footnotesize 
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/inf_census_top_proj}
\\
\\\midrule
\input{figures/demo_top_proj}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/inf_census_inf_top_spill}
\\
\\\midrule
\input{figures/demo_inf_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\begin{tabular}{lCCCCC}
\toprule
\input{figures/inf_census_for_top_spill}
\\
\\\midrule
\input{figures/demo_for_top_spill}
\bottomrule
\end{tabular}
\begin{tablenotes}
...
% \midrule
% \input{figures/plottreattable}
% \\[-.5em]
% Plot rings (km) \\
% \input{figures/areatreattable}	
% \bottomrule
% \end{tabular}
% \begin{tablenotes}
