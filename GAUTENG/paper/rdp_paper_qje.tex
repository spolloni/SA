...
%%%   - add in project types, and locations
%%%   - in this way, in these places, in this legal environment produces a bad outcome
%%%   - ``in this context,'' in the abstract ...   the gov. should stop investing in housing?? (no!)
%%% a lot of program design issues implicated and there are ways that it could be improved
%%% backyarding ???
% % % take 6.6 million out of the abstract ! ! !



%%% split into 3, and also add the caveat: clear explanation of what is going on in the market...
...
\includegraphics[width=\textwidth,trim={0cm 0cm 0cm 0cm}]{figures/casestudy2_medium.png}
        \label{fig:bblumaps}
\end{figure*} 
