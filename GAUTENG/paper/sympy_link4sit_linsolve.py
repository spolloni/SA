...
if save_sols == 1:
	sols = linsolve([u1-u2,u2-u3,u3-u4,u1i-u2i,u2i-u3i,u3i-u4i,u1-u1i,nn],[N1,N2,N3,N4,N1i,N2i,N3i,N4i])
	print sols
	#sols =  solve([u1-u2,u2-u3,u3-u4,u1i-u2i,u2i-u3i,u3i-u4i,u1-u1i,nn],[N1,N2,N3,N4,N1i,N2i,N3i,N4i],set=True)
	with open(spot+'eq3lin.txt', "w") as outf:
	    pickle.dump(sols, outf)


# ##### MAKE GRAPHS #####

# with open(spot+'eq3lin.txt') as inf:
