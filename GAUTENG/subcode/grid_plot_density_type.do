...
prog define plotmeans_pre_prog;
    plotmeans_pre 
    bblu_`1'_pre_means${V}_`2' `1' rdp placebo
...
*plotmeans_pre_prog for 4 "keep if type_rdp==." "keep if type_placebo==." ;
*plotmeans_pre_prog inf 4 "keep if type_rdp==." "keep if type_placebo==." ;
...
if $graph_plotmeans_rawchan == 1 {;
  ...
  plotchanges 
    bblu_`1'_rawchanges${V}_`2' `1' rdp placebo
    "Constructed" "Unconstructed"
...
*plotchanges_prog for 4 "keep if type_rdp==." "keep if type_placebo==." ;
*plotchanges_prog inf 4 "keep if type_rdp==." "keep if type_placebo==." ;
