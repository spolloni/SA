...
if $graph_plotmeans_rawchan == 1 {;
  ...
  preserve;
    ...
    duplicates drop d`3', force;
    ren d`3' D;
    save "${temp}pmeans_`3'_temp_het.dta", replace;
  restore;
  ...
  preserve;
    ...
    duplicates drop d`4', force;
    ren d`4' D;
    save "${temp}pmeans_`4'_temp_het.dta", replace;
  restore;

   preserve; 
     use "${temp}pmeans_`3'_temp_het.dta", clear;
     merge 1:1 D using "${temp}pmeans_`4'_temp_het.dta";
     keep if _merge==3;
     drop _merge;
