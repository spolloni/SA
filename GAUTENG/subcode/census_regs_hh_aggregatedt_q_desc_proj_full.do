...
replace SUM$rows_set = SUM$rows_set + " \\";

export delimited using "census_compare_houses_proj_full${V}.tex", novar delimiter("&") replace;
...
**** NOW JUST LOOK AT FORMAL HOUSES !!!! ;

global rows_set = 5;

mat SUM = J(10, $rows_set,.);
...
export delimited using "census_compare_houses_proj_for${V}.tex", novar delimiter("&") replace;
