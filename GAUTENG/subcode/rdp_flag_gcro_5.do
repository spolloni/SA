...
g rdp_proj_status = 0  ;
* if planning==1 | uncertain==1 | proposed==1 | investigating==1 | future==1  ; 
...
**** CREATE GCRO FULL FILE ;

local qry = " SELECT GP.* FROM gcro_publichousing AS GP " ;
...
local qry = "
   ...
   JOIN int_gcro_full_erven AS C ON A.property_id = C.property_id
