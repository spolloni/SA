...
global plot_density_paperstef_query		= 0 /* 2 */
global plot_density_paperstef 			= 0
global plot_density_paperstef_het 		= 0
global plot_density_paperstef_NOFE 	    = 0
global plot_density_paperstef_NOFE_het  = 0

global census_regs_query  				= 0 /* 2 */
global census_regs_hh_aggregated  	    = 0 /* 0 */
global census_regs_hh_aggregated_het 	= 0 /* 0 */
global census_regs_hh_aggregated_dwell  = 0 /* 2 */

global census_regs_pers_query 			= 0 /* 2 */
global census_regs_pers_aggregated      = 0 /* 0 */
global census_regs_pers_aggregated_het  = 0 /* 0 */

global generate_placebo_year 			= 0 /* 0 */
global export2gradplot 					= 0 /* 0 */
