...
replace D = round(D,750)

cap drop DR
g DR = distance_rdp if con==1 
replace DR = distance_placebo if con==0 
g DP = DR<=500 & DR>=0
...
g D_0 = D==0
g D_0_treat = D_0*treat

g D_750 = D==750
g D_750_treat = D_750*treat


areg lprice D_*  treat if con==1, a(LL) cluster(cluster_joined)
* outreg2 using test1, replace

* g DI_low = inc_q == 0
* g DI_1500_low = D==1500 & inc_q==0

g DI_treat_low = post==1 & inc_q==0

g DI_0_low = D==0 & inc_q==0
g DI_0_treat_low = D_0==1 & treat==1 &  inc_q==0

g DI_750_low = D==750 & inc_q==0
g DI_750_treat_low = D_750==1 & treat==1 & inc_q==0


* g DI_1500_high = D==1500 & inc_q==1
g DI_treat_high = post==1 & inc_q==1

g DI_0_high = D==0 & inc_q==1
g DI_0_treat_high = D_0==1 & treat==1 &  inc_q==1

g DI_750_high = D==750 & inc_q==1
g DI_750_treat_high = D_750==1 & treat==1 & inc_q==1

areg lprice DI_* if con==1, a(LL) cluster(cluster_joined)
*outreg2 using test1, replace



g DP_treat_high = treat==1 & inc_q==1
g DP_0_high = DP==1 & inc_q==1
g DP_0_treat_high = DP==1 & treat==1 &  inc_q==1

g DP_treat_low = treat==1 & inc_q==0
g DP_0_low = DP==1 & inc_q==0
g DP_0_treat_low = DP==1 & treat==1 &  inc_q==0

areg lprice DP_* if con==1, a(LL) cluster(cluster_joined)


areg lprice DP_* if con==0, a(LL) cluster(cluster_joined)





g DI_treat_low_con = post==1 & inc_q==0 & con==1

g DI_0_low_con = D==0 & inc_q==0 & con==1
g DI_0_treat_low_con = D_0==1 & treat==1 &  inc_q==0 & con==1

g DI_750_low_con = D==750 & inc_q==0 & con==1
g DI_750_treat_low_con = D_750==1 & treat==1 & inc_q==0 & con==1


* g DI_1500_high = D==1500 & inc_q==1
g DI_treat_high_con = post==1 & inc_q==1 & con==1

g DI_0_high_con = D==0 & inc_q==1 & con==1
g DI_0_treat_high_con = D_0==1 & treat==1 &  inc_q==1 & con==1

g DI_750_high_con = D==750 & inc_q==1 & con==1
g DI_750_treat_high_con = D_750==1 & treat==1 & inc_q==1 & con==1

g DI_low_con = inc_q==0 & con==1
g DI_high_con = inc_q==1 & con==1

g DI_low_con_treat = inc_q==0 & con==1 & treat==1
g DI_high_con_treat = inc_q==1 & con==1 & treat==1


areg lprice DI_*, a(LL) cluster(cluster_joined)
outreg2 using test1, replace
...
pf "price_dist_3d_no_ctrl"   "dist"          750               ""              0              1         0             LL           0

* pf "price_dist_3d_no_ctrl"   "dist"          750               ""              0              0         0             LL           0


/*

pf "price_time_3d_no_ctrl"   "time"          12                48               0             1         0       LL            0
pf "price_time_3d_ctrl"   "time"          12                48               0             1         1       LL            0
...
pf "price_time_2d_no_ctrl"   "time"          12                48               0             0         0          LL    0
pf "price_time_2d_ctrl"      "time"          12                48               0             0         1          LL    0
