...
%\caption{Purchase Price Densities}
 \includegraphics[scale=.53]{figures/price_histogram.pdf} 
\end{figure}
}\end{minipage} 
} ;
...
\centering
\resizebox{\textwidth}{!}{  
\input{input_tex/census_hh_time_table}
}
...
\centering
\resizebox{\textwidth}{!}{  
\input{input_tex/census_hh_table}
}
% descriptive_statistics.do program: write_census_hh_table
...
\begin{table}
{\footnotesize
\input{input_tex/gradient_regressions}
}
\end{table}
\end{frame}
...
\begin{table}
{\footnotesize
\input{input_tex/gradient_regressions_placebo}
}
\end{table}
\end{frame}
...
\begin{table}
{\footnotesize
\input{input_tex/census_regs_hh_sample}
}
\end{table}
\end{frame}
...
\begin{table}
{\footnotesize
\input{input_tex/census_regs_pers_sample}
}
\end{table}
\end{frame}
...
\begin{center}
\begin{figure}
\includegraphics[scale=0.72]{figures/bbluplot.pdf}
\vspace{-3mm}
\end{figure}
\end{center}
\end{frame}
...
\includegraphics[width=0.5\textwidth,trim={.75cm 0cm .21cm 0cm}]{figures/bbluplot.pdf}
   \hfill
\includegraphics[width=0.5\textwidth,trim={.75cm 0cm .21cm 0cm},clip]{figures/bbluplot_placebo.pdf}
